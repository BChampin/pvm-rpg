...
import { Card, CardBody, CardHeader, Divider, Image, Kbd } from "@nextui-org/react"
        ...
        <Card>
          ...
          <CardBody>
            ...
            <ul className="list-inside list-disc">
              <li className="mb-2">
                {i18n('home.howto.categories.p1')}
              </li>
              <li className="mb-2">
                {i18n('home.howto.categories.p2')}
              </li>
              <li className="mb-2">
                {i18n('home.howto.categories.p3')}
              </li>
            </ul>
          </CardBody>
          <Divider />
          <CardBody>
            ...
            <p className="mb-2">
              {i18n('home.howto.times.p1')}
            </p>
            <ul className="list-inside list-decimal">
              <li className="mb-2">
                {i18n('home.howto.times.p2')}
              </li>
              <li className="mb-2">
                {i18n('home.howto.times.p3')}<Kbd className="font-semibold">Name</Kbd>{i18n('home.howto.times.p4')}
              </li>
              <li className="mb-2">
                {i18n('home.howto.times.p5')}
              </li>
              <li className="mb-2">
                {i18n('home.howto.times.p6')}
              </li>
              <li className="mb-2">
                {i18n('home.howto.times.p7')}
              </li>
            </ul>
          </CardBody>
          <Divider />
          <CardBody>
            ...
            <p>
              {i18n('home.howto.tips.p1')}<Kbd className="font-semibold">/list</Kbd> {i18n('home.howto.tips.p2')}
            </p>
          </CardBody>
        </Card>
      </main>
